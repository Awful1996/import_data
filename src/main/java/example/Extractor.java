...
public class Extractor {
    ...
    public void getPageLinks(String URL) {
        if (!links.contains(URL)) {
            try {
                ...
                Elements otherLinks = document.select("a[href^=\"http://gpk.gov.by/maps/arkhiv-ocheredey.php?ochered_id=/\"]");
    ...
    public static void main(String[] args) {
        ...
        bwc.getPageLinks("http://gpk.gov.by/maps/arkhiv-ocheredey.php");
        bwc.getArticles();
